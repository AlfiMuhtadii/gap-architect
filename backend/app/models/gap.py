...
class GapResult(Base):
    ...
    hard_skills_missing: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    soft_skills_missing: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    technical_skills_missing: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    transversal_soft_skills_missing: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    language_skills_missing: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
